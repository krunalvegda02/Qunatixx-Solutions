      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
          ...
          <motion.div
            ...
            className="relative w-full max-w-2xl h-auto max-h-[95dvh] sm:max-h-[90vh] bg-bg-elevated border border-border-primary rounded-xl overflow-y-auto overflow-x-hidden z-10 shadow-[0_30px_70px_var(--shadow-heavy)] theme-transition font-sans flex flex-col"
          >
            {/* Top Glow bar */}
            ...
            {!isSubmitted ? (
              <div className="p-5 sm:p-8 text-left">
                <div className="mb-5 sm:mb-6">
                  <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[10px] sm:text-xs font-semibold bg-highlight/15 text-highlight border border-highlight/20 mb-2 sm:mb-3">
                    <Calendar size={12} /> Live Consulting
                  </span>
                  <h3 className="text-xl sm:text-2xl font-display font-bold text-text-primary leading-tight">
                ...
                <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      {['₹10k-₹25k', '₹25k-₹50k', '₹50k+'].map((budgetOption) => (
                        <button
                          key={budgetOption}
                          type="button"
                          onClick={() => setFormData({ ...formData, budget: budgetOption })}
                          className={`py-2 px-2 sm:px-3 text-[10px] sm:text-xs font-medium rounded-md border transition-all cursor-pointer ${
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-3 sm:pt-4 border-t border-border-primary">
