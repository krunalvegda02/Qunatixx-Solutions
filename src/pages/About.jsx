...
import { Target, Shield, Users, Flame, Cpu, ArrowUpRight, CheckCircle2, ShieldAlert, MessageSquare, Key, RefreshCw, Github, Linkedin } from 'lucide-react';
...
export default function About() {
  ...
  return (
    <div className="relative overflow-hidden bg-bg-primary text-text-primary theme-transition bg-grid-tech pt-28 pb-16 min-h-screen">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-24 font-sans relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          
          <div className="text-left space-y-6">
            <h2 className="text-2xl sm:text-3xl font-display font-bold text-text-primary">Our Story & Core Philosophy</h2>
            ...
            <div className="bg-bg-secondary/60 border border-border-primary rounded-xl p-4.5 flex gap-4 items-center backdrop-blur-sm">
          ...
          <div className="space-y-6">
            <div className="bg-bg-card border border-border-primary rounded-xl p-6 text-left relative overflow-hidden group hover:border-accent/30 transition-colors">
              <div className="absolute top-0 right-0 w-24 h-24 bg-accent/5 rounded-bl-full pointer-events-none group-hover:bg-accent/8 transition-colors" />
              <div className="w-10 h-10 rounded-lg bg-accent/10 text-accent flex items-center justify-center mb-4"><Target size={20} /></div>
              <h3 className="text-lg font-bold text-text-primary mb-2 font-display">Our Mission</h3>
              <p className="text-xs sm:text-sm text-text-secondary leading-relaxed font-light">
            ...
            <div className="bg-bg-card border border-border-primary rounded-xl p-6 text-left relative overflow-hidden group hover:border-highlight/30 transition-colors">
              <div className="absolute top-0 right-0 w-24 h-24 bg-highlight/5 rounded-bl-full pointer-events-none group-hover:bg-highlight/8 transition-colors" />
              <div className="w-10 h-10 rounded-lg bg-highlight/10 text-highlight flex items-center justify-center mb-4"><Shield size={20} /></div>
              <h3 className="text-lg font-bold text-text-primary mb-2 font-display">Our Vision</h3>
              <p className="text-xs sm:text-sm text-text-secondary leading-relaxed font-light">
      ...
      {/* Core Values Section */}
      <section className="py-20 bg-bg-secondary/40 border-y border-border-primary mb-24 relative z-10 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="mb-16">
            <span className="text-xs uppercase tracking-wider font-semibold text-accent font-mono">Commitment</span>
            <h2 className="text-3xl font-display font-bold text-text-primary mt-2">Our Code of Values</h2>
            <p className="text-sm text-text-secondary mt-2 font-sans font-light">These guidelines dictate how we write files, coordinate sprints, and interface with partners.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 text-left font-sans">
            {values.map((val, i) => {
              const Icon = val.icon;
              return (
                <div key={i} className="bg-bg-card border border-border-primary hover:border-accent/20 rounded-xl p-6 transition-all group shadow-sm hover:shadow-md">
                  <div className="w-10 h-10 rounded-lg bg-bg-secondary flex items-center justify-center text-accent mb-4 border border-border-primary group-hover:border-accent/30 group-hover:bg-accent/10 transition-colors"><Icon size={18} /></div>
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 mb-24 relative z-10">
        <div className="text-center mb-16">
          <span className="text-xs uppercase tracking-wider font-semibold text-accent font-mono">Engagement Model</span>
          <h2 className="text-3xl font-display font-bold text-text-primary mt-2">How We Work with Clients</h2>
          <p className="text-xs sm:text-sm text-text-secondary mt-2 font-light max-w-xl mx-auto">
            We operate under a transparent framework. Here is our client onboarding and development roadmap.
          </p>
        </div>

        {/* Playbook track */}
        <div className="relative border-l border-border-primary pl-6 sm:pl-10 space-y-10 max-w-3xl mx-auto text-left font-sans">
          {playbook.map((item, i) => (
            <div key={i} className="relative group">
              {/* timeline node dot */}
              <div className="absolute -left-[31px] sm:-left-[47px] top-1.5 w-4 h-4 rounded-full bg-bg-primary border-[3px] border-accent group-hover:bg-accent transition-all" />
              <div className="bg-bg-card border border-border-primary group-hover:border-accent/25 p-5 rounded-xl transition-all shadow-sm">
                <span className="text-[10px] font-bold font-mono text-accent">STEP {item.step}</span>
                <h3 className="text-lg font-bold text-text-primary mt-1 mb-2 font-display">{item.title}</h3>
      ...
      {/* Leadership Section */}
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mb-24 font-sans relative z-10">
        <div className="text-center mb-20">
          <span className="text-xs uppercase tracking-[0.2em] font-extrabold text-accent bg-accent/10 px-3.5 py-1.5 rounded-sm inline-block">
            Our Leadership
          </span>
          <h2 className="text-3xl sm:text-4xl font-display font-extrabold text-text-primary mt-4">
            Direct Access to Co-Founders
          </h2>
          <p className="text-xs sm:text-sm text-text-secondary mt-3 font-light max-w-xl mx-auto leading-relaxed">
        ...
        <div className="space-y-16 max-w-5xl mx-auto">
          {leadership.map((lead, i) => {
            ...
            return (
              <div 
                key={i} 
                className="glass-card border border-white/[0.08] hover:border-white/[0.15] rounded-3xl p-6 sm:p-8 lg:p-10 relative overflow-hidden group shadow-2xl transition-all duration-500 bg-gradient-to-br from-bg-card/50 via-bg-card/20 to-transparent"
              >
                ...
                <div className="absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.003)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.003)_1px,transparent_1px)] bg-[size:24px_24px] pointer-events-none opacity-30 -z-10" />
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center relative z-10">
                  ...
                  <div className={`lg:col-span-5 flex justify-center ${isEven ? 'lg:order-first' : 'lg:order-last'}`}>
                    <div className="relative group/photo">
                      ...
                      <div className="absolute -inset-2 rounded-2xl bg-gradient-to-tr from-accent/20 to-highlight/20 opacity-0 group-hover/photo:opacity-100 blur-lg transition duration-700 -z-10" />
                      
                      {/* Inner Photo Frame */}
                      <div className="w-56 h-56 sm:w-64 sm:h-64 rounded-2xl overflow-hidden border border-white/[0.08] bg-bg-secondary flex items-center justify-center relative shadow-2xl aspect-square">
                        {lead.photo ? (
                          <img 
                            src={lead.photo} 
                            alt={lead.name} 
                            className="w-full h-full object-cover grayscale group-hover/photo:grayscale-0 transition-all duration-700 scale-100 group-hover/photo:scale-105"
                          />
                        ) : (
                          <span className="font-display text-4xl font-extrabold text-text-primary">{lead.initial}</span>
                        )}

                        {/* Floating Status Indicator Badge */}
                        <div className="absolute bottom-3 left-3 bg-bg-primary/90 backdrop-blur-md border border-white/[0.08] px-3 py-1 rounded-full flex items-center gap-1.5 shadow-md">
                          <span className="relative flex h-2 w-2">
                            <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75"></span>
                            <span className="relative inline-flex rounded-full h-2 w-2 bg-emerald-500"></span>
                          </span>
                          <span className="text-[9px] font-mono font-bold text-text-primary tracking-wider uppercase">Active Staging</span>
                        </div>
                      </div>

                      {/* Tech Role Accent Strip */}
                      <div className={`absolute -top-3 -right-3 px-3 py-1 rounded-lg text-[10px] font-mono font-bold tracking-widest uppercase border backdrop-blur-md shadow-lg ${
                        lead.accentColor === 'cyan' ? 'bg-[#0EA5E9]/10 text-[#0EA5E9] border-[#0EA5E9]/20 shadow-[#0EA5E9]/5' : 'bg-[#E11D48]/10 text-[#E11D48] border-[#E11D48]/20 shadow-[#E11D48]/5'
                      }`}>
                  ...
                  <div className="lg:col-span-7 text-left space-y-6">
                    <div>
                      ...
                      <div className="flex flex-wrap items-center gap-4 justify-between">
                        <div>
                          <h3 className="text-2xl sm:text-3xl font-extrabold font-display text-text-primary tracking-tight">
                            {lead.name}
                          </h3>
                          <span className="text-xs sm:text-sm font-semibold text-accent font-mono block mt-1 tracking-wider uppercase">
                            {lead.role}
                          </span>
                        </div>
                    ...
                    <div className="relative pl-5 py-2 border-l-2 border-accent/40 bg-white/[0.01] rounded-r-lg pr-4 font-sans italic text-sm sm:text-base text-text-primary/95 leading-relaxed font-light">
                      <span className="absolute left-1.5 top-0 font-serif text-3xl text-accent/30 select-none">“</span>
                      {lead.quote}
                    </div>

                    {/* System Stats Block */}
                    <div className="grid grid-cols-3 gap-4 bg-bg-secondary/40 border border-white/[0.04] p-4 rounded-xl font-mono text-[10px]">
                      {lead.stats.map((stat, idx) => (
                        <div key={idx} className="space-y-1">
                          <span className="text-text-muted block uppercase tracking-wider text-[8px]">{stat.label}</span>
                          <span className="text-text-primary font-bold block truncate">{stat.value}</span>
                        </div>
                      ))}
                    </div>
                    ...
                    <div className="space-y-2">
                      <span className="text-[9px] uppercase tracking-widest text-text-muted font-mono font-bold block">Focus Domains</span>
                      <div className="flex flex-wrap gap-2">
                        {lead.focus.map((foc, idx) => (
                          <span 
                            key={idx} 
                            className="px-2.5 py-1 rounded-md text-[10px] font-mono text-text-secondary border border-white/[0.05] bg-white/[0.02] hover:border-accent/20 hover:text-text-primary transition-all cursor-default"
                          >
                            {foc}
                          </span>
                        ))}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center relative z-10">
            ...
            <div className="lg:col-span-7 text-left space-y-5">
              <span className="text-[9px] font-mono font-bold uppercase tracking-[0.2em] text-accent bg-accent/10 px-3 py-1.5 rounded-sm border border-accent/20 inline-flex items-center gap-1.5">
                <Shield size={11} className="text-highlight animate-pulse" /> 
              ...
              <h2 className="text-3xl sm:text-4xl font-display font-extrabold text-text-primary tracking-tight leading-tight">
                Ready to Map Out <br className="hidden sm:inline" /> Your Architecture?
              </h2>
            ...
            <div className="lg:col-span-5 w-full">
              <div className="bg-bg-secondary/40 border border-white/[0.05] rounded-lg p-5 shadow-inner relative overflow-hidden backdrop-blur-md">
                <span className="text-[9px] font-mono text-text-muted uppercase tracking-widest block mb-4">Our Guarantees</span>
                <div className="space-y-3.5 font-mono text-[9px] text-text-secondary font-light">
                  ...
                  <div className="flex justify-between border-b border-border-primary/40 pb-1.5">
                    ...
                    <span className="text-highlight font-bold">100% Transfer Guarantee</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-text-muted">Virtual Security:</span>
                    <span className="text-text-primary font-bold">VPC & Cloud Encrypted</span>
                  </div>
                </div>
              </div>
            </div>
